...
/**
 * A dynamic "Gold Dust" particle overlay that adds texture.
 */
const GoldDustOverlay = ({ isHovered }) => {
  return (
    <motion.div 
      className="absolute inset-0 z-10 pointer-events-none opacity-0 mix-blend-overlay"
    ...
    >
      <Link href={`/category/${category.slug}`} className="block w-full h-full transform-style-3d">
        ...
        >
          ...
          <GoldDustOverlay isHovered={isHovered} />
